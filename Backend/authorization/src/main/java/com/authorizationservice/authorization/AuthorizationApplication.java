...
public class AuthorizationApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception{
		AuthenticationRequest user1 = new AuthenticationRequest("shubhamgupta7","123456789");
		AuthenticationRequest user2 = new AuthenticationRequest("satyadurga","123456789");
